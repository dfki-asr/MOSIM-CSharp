...
namespace GraspPointService
{
    public class GraspPointService : MGraspPoseService.Iface
    {
        ...
        MBoolResponse MMIServiceBase.ISync.Dispose(Dictionary<string, string> properties)
        {
            throw new NotImplementedException();
        }

        MBoolResponse MMIServiceBase.ISync.Restart(Dictionary<string, string> properties)
        {
            throw new NotImplementedException();
        }
    }

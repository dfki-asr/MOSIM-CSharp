        ...
        public override MBoolResponse AssignInstruction(MInstruction instruction, MSimulationState simulationState)
        {
            ...
            if(instruction.Properties != null)
            {
                if (instruction.Properties.ContainsKey("Mode"))
                {
                    ...
                    MMICSharp.Logger.Log(MMICSharp.Log_level.L_DEBUG, "Operation mode set: " + this.Mode);
                ...
                if (instruction.Properties.ContainsKey("GoalPosture"))
                {
                    ...
                    try
                    {
                        ...
                        MMICSharp.Logger.Log(MMICSharp.Log_level.L_DEBUG, "Using defined goal posture");

                    }
                    catch (Exception)
                    {
                        MMICSharp.Logger.Log(MMICSharp.Log_level.L_ERROR, "Problem receiving the posture constraint");

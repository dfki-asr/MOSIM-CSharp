        ...
        public override MBoolResponse AssignInstruction(MInstruction instruction, MSimulationState simulationState)
        {
            ...
            foreach (HandContainer hand in this.ActiveHands)
            {
                ...
                if (hand.TurningAxis != null)
                {
                    ...
                    {
                        MMICSharp.Logger.Log(MMICSharp.Log_level.L_INFO, $"Called Turning MMU with turning axis defined. Min angle {hand.MinAngle}, max angle {hand.MaxAngle}.");
                    ...
                    {
                        MMICSharp.Logger.Log(MMICSharp.Log_level.L_INFO, $"Called Turning MMU with turning axis defined. Turning angle {hand.TurningAngle}.");

...
namespace MMILauncher
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        public MainWindow()
        {
            ...
            Logger.Instance = new WPFLogger(this);
            Logger.Instance.Level = Log_level.L_DEBUG;
            Logger.Log(Log_level.L_INFO, "Welcome to the Logger");
        ...
        public void LoadMMULibraries()
        {
            ...
            for (int i = 0; i < mmuLibs.Length; i++)
                if (mmuLibs[i].Substring(mmuLibs[i].Length-5) ==".json")
                {
                    ...
                    {
                        WPFLogger.Log(Log_level.L_ERROR, $"Problem loading MMU library {mmuLibs[i]}: {e.Message}");
                        //System.Windows.MessageBox.Show("Problem loading MMU Library: " + e.Message, "Load MMU Libraries " + mmuLibs[i], MessageBoxButton.OK, MessageBoxImage.Error);
                    }
                }
        ...
        private void adapterListView_PreviewMouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            {
                WPFLogger.Log(Log_level.L_ERROR, $"Problem displaying Adapter details: {ex.Message}");
                System.Windows.MessageBox.Show("Problem displaying Adapter details: " + ex.Message, "Display Adapter Details", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void serviceListView_PreviewMouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            {
                WPFLogger.Log(Log_level.L_ERROR, $"Error on displaying service info {ex.Message}");
            }
        }
        ...
        private void mmuView_PreviewMouseDoubleClick(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
            ...
            {
                WPFLogger.Log(Log_level.L_ERROR, $"Problem displaying MMU details: {ex.Message}");
                System.Windows.MessageBox.Show("Problem displaying MMU details: " + ex.Message, "Display MMUs " + ob.Name, MessageBoxButton.OK, MessageBoxImage.Error);
        ...
        private void SetupEnvironment(string adapterPath, string mmuPath, string servicePath)
        {
            ...
            foreach (string folderPath in Directory.GetDirectories(mmuPath))
            {
                ...
                WPFLogger.Log(Log_level.L_INFO, "Start executable MMU");
        ...
        private void UpdateLoadableMMUs()
        {
            ...
            for (int i = RuntimeData.AdapterInstances.Count - 1; i >= 0; i--)
            {
                ...
                {
                    WPFLogger.Log(Log_level.L_ERROR, $"Problem receiving loadable MMUs: {e.Message}");
                    //System.Windows.MessageBox.Show("Problem receiving loadable MMUs: " + e.Message, "Update Loadable MMUs " + adapter.Name, MessageBoxButton.OK, MessageBoxImage.Error);
                }
        ...
        private void mmuView_SelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
